...
import 'package:bamiki/Influencer/Rates/RatesVideoSuccessful.dart';
...
class ProfilePriceVideo extends StatefulWidget {

  final String TYPE;

  ProfilePriceVideo({Key? key, required this.TYPE});

  @override
  _ProfilePriceVideoState createState() => _ProfilePriceVideoState();
}

class _ProfilePriceVideoState extends State<ProfilePriceVideo> {
  String hint = r"$0";
  ...
  priceShoutOut() async {
    ...
    if(response.statusCode == 200){
      ...
      Navigator.push(
          context, MaterialPageRoute(builder: (context) => RatesVideoSuccessful()));
      Flushbar(
        message: message,

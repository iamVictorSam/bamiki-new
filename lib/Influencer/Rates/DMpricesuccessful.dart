...
class DMPriceSuccessful extends StatefulWidget {
  @override
  _DMPriceSuccessfulState createState() => _DMPriceSuccessfulState();
}

class _DMPriceSuccessfulState extends State<DMPriceSuccessful> {
  @override
        ...
        child: Stack(
            children: <Widget>[
              Positioned(
                      ...
                      child: Stack(
                          children: <Widget>[
                            Positioned(
                                top: 75,
                                left: 16,
                                child: Text('DM/Replies price set  successful ', textAlign: TextAlign.center, style: TextStyle(
                  ...
                  top: 51,
                  left: 154,
                  child: Text('DM price', textAlign: TextAlign.center, style: TextStyle(
                      color: Color.fromRGBO(0, 0, 34, 1),
                      fontFamily: 'Oxygen',
                      fontSize: 16,
                      letterSpacing: 0 /*percentages not used in flutter. defaulting to zero*/,

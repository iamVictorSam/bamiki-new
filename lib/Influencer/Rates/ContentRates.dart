...
class ContentRates extends StatefulWidget {
  const ContentRates({Key? key}) : super(key: key);

  @override
  _ContentRatesState createState() => _ContentRatesState();
}

class _ContentRatesState extends State<ContentRates> {

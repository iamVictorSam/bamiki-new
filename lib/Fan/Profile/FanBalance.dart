...
import 'package:bamiki/Fan/Profile/FundWallet.dart';
...
class FanBalanace extends StatefulWidget {
  const FanBalanace({Key? key}) : super(key: key);

  @override
  _FanBalanaceState createState() => _FanBalanaceState();
}

class _FanBalanaceState extends State<FanBalanace> {
  @override
            ...
            child: Stack(
              children: [
                Padding(
                  ...
                  child: SvgPicture.asset('assets/images/fund_wallet.svg',
                      width: 45,
                      height: 45,
                      semanticsLabel: 'vector'),
                ),

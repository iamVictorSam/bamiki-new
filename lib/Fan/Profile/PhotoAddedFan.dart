...
import 'AddProfilePictureFan.dart';

class PhotoAddedFan extends StatefulWidget {
  const PhotoAddedFan({Key? key}) : super(key: key);

  @override
  _PhotoAddedFanState createState() => _PhotoAddedFanState();
}

class _PhotoAddedFanState extends State<PhotoAddedFan> {
  @override

...
import 'AlternativeSignUp.dart';
import 'Login/LoginAndroid.dart';

class celebritySelected {
  final String celebrity;

  celebritySelected(this.celebrity);
}

class LandingSignUpTwo extends StatefulWidget {
  @override
  _LandingSignUpTwoState createState() => _LandingSignUpTwoState();
}

class _LandingSignUpTwoState extends State<LandingSignUpTwo> {

  String account = "celebrity";
    ...
    return Container(
        ...
        child: Stack(children: <Widget>[
          ...
          Positioned(
              ...
              left: 40,
              child: Text(
                'Short description about who a celebrity is and \ncelebrity account here.',
          ...
          Positioned(
              ...
              child: GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => CreateAcountInfluencer(ACCOUNT: account)),
                  );
                },
                child: Opacity(
                  opacity: 1,
